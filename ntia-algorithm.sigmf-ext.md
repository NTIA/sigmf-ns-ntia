...
| `x_label`     | false    | string   | N/A  | X-axis label, e.g.,  `"Frequency (Hz)"`,`"dBm"`, `"Time (ms)"`                                                                                                                                                                                   |
...
| `x_axis`      | false    | array    | N/A  | X-axis values. Elements in the array must be uniform in type and one of `integer`, `number`, or `string`.                                                                                                                                        |
...
| `y_axis`      | false    | array    | N/A  | Y-axis values. Elements in the array must be uniform in type and one of `integer`, `number`, or `string`.                                                                                                                                        |
| `processing`  | false    | string[] |N/A| The IDs associated with the additional metadata describing the processing that produced the data product. Note: this is processing that was performed in addition to any referenced in the `Global` object's `data_products_processing` element. |
