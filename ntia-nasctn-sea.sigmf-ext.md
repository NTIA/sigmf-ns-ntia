...
The `ntia-nasctn-sea` namespace provides SigMF metadata extensions for NASCTN Sharing Ecosystem Assessment (SEA) project.
...
|---------------------------------|--------------|----------|-------|------------------------------------------|
| `max_of_max_channel_powers`     |true| double[] |N/A| The maximum power per channel.           |
