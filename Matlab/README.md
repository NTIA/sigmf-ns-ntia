...
|`gov.doc.ntia.sigmf.ext.annotation.location`|[ntia-location](https://github.com/NTIA/sigmf-ns-ntia/blob/master/ntia-location.sigmf-ext.md)|Contains objects to represent the annotation objects defined in [ntia-location](https://github.com/NTIA/sigmf-ns-ntia/blob/master/ntia-location.sigmf-ext.md) including `LocationAnnotation`|
