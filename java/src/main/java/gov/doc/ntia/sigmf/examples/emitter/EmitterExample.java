...
public class EmitterExample implements Example {
    ...
    public MetaDoc getExample() {
        ...
        antennaSpec.setSupplementalInformation( "https://www.european-antennas.co.uk/media/1638/ds1505-060510.pdf");
        ...
        transmitter.setSupplementalInformation( "https://www.keysight.com/us/en/assets/7018-03380/data-sheets/5991-0038.pdf");
