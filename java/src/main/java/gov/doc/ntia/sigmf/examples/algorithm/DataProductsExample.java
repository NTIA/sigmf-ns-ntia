...
import gov.doc.ntia.sigmf.Global;import gov.doc.ntia.sigmf.MetaDoc;
import gov.doc.ntia.sigmf.examples.Example;
import gov.doc.ntia.sigmf.examples.ExampleUtils;
import gov.doc.ntia.sigmf.ext.global.algorithm.AmplitudeProbabilityDistribution;import gov.doc.ntia.sigmf.ext.global.algorithm.PeriodicFramePower;import gov.doc.ntia.sigmf.ext.global.algorithm.PowerSpectralDensity;
...
public class DataProductsExample implements Example {
  ...
  public MetaDoc getExample() {
      ...
      Double[] firNumeratorCoefficients = new Double[] {
                0.22001755985277486,
              1.8950858799155859,
              8.083698129129007,
              22.28438408611688,
      ...
      Double[] iirDenomCoefficients = new Double[]{
                1.0,
              5.984606843057637,
              19.199454663117217,
              40.791247158352408,
