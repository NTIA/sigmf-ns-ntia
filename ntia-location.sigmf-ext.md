...
|`orientation`|false|string|N/A|Clockwise rotation of each axis with respect to some reference vector, in degrees. Typically used in simpler coordinate systems. E.g. Annotating values as true north instead of magnetic north by including a magnetic declination (0,0,0.35)|
